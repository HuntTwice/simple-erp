      ...
      <div class="manager-main-left">
        <el-menu :default-openeds="['info', 'user']" router style="border: none" :default-active="$route.path">
          ...
          <el-submenu index="stockManager">
            <template slot="title">
              <i class="el-icon-shopping-cart-2"></i><span>采购管理</span>
            </template>
            <el-menu-item index="/stock">采购信息</el-menu-item>
            <el-menu-item index="/stockBack">采购退货信息</el-menu-item>
          </el-submenu>

          <el-submenu index="saleManager">
            <template slot="title">
              <i class="el-icon-sell"></i><span>销售管理</span>
            </template>
            <el-menu-item index="/sale">销售信息</el-menu-item>
            <el-menu-item index="/saleBack">销售退货信息</el-menu-item>
          </el-submenu>

          <el-submenu index="system">
            <template slot="title">
              <i class="el-icon-user"></i><span>系统管理</span>
            </template>
